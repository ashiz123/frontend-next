...
// import { SectionInterface } from "./page";
...
interface ConfirmReservationModelProps {
  ...
  selectedOption: ParkingResult;
  closeModal: () => void;
  openModal: boolean;
}

const ConfirmReservationModel: React.FC<ConfirmReservationModelProps> = ({
  vehicle,
  selectedOption,
  closeModal,
  openModal,
  ...
  const onSubmit = async (e: React.MouseEvent<HTMLButtonElement>) => {
    ...
    // try {
    //   const data = await fetchReservation(vehicle, selected);
    //   if (data?.status === 200) {
